...
- For Moonbeam: Click `Run workflow` on [Deploy with Parallel RPC](https://github.com/parallel-finance/moonbeam-distribution-subql/actions/workflows/deploy-moonbeam.yml) action, and enter the `SUBQL_ACCESS_TOKEN`, then click the button again.

### Get IPFS CID from github action

The check the response in deployment action `Publish to IPFS` step, for [example](https://github.com/parallel-finance/moonbeam-distribution-subql/runs/5879173033?check_suite_focus=true ), there should be as following:
...
- Moonbeam: https://project.subquery.network/project/parallel-finance/moonbeam-distribution-subql
- Moonbeam (test blockchain): https://project.subquery.network/project/parallel-finance/moonbeam-distribution-subql-staging

Note: Please use staging branch to deploy Moonbeam staging env.
